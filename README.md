...
```bash
  ...
  Una vez que tenemos nuestra apikey, crear un archivo .env en la raíz del proyecto y crear una variable VITE_APIKEY con la key. Ejemplo: VITE_APIKEY=TU_API_KEY.
```
